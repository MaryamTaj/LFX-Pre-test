...
$ cmake -GNinja -Bbuild -DCMAKE_BUILD_TYPE=Release \  
  ...
  .
```
<img src="https://github.com/MaryamTaj/LFX-Pre-test/blob/main/cmake">

```bash
$ cmake --build build
  cmake –install build
```
<img src="https://github.com/MaryamTaj/LFX-Pre-test/blob/main/cmake%20%E2%80%93install%20build">
